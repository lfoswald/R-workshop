---
title: "R-Primer 2"
subtitle: "Data cleaning, wrangling and plotting with the Tidyverse"
output: 
  html_document:
    toc: TRUE
    df_print: paged
...
## Theme & graph appearance `r emo::ji("nail_care")`
...
### Our first plot `r emo::ji("artist_palette")`

For our very first plot using `ggplot2`, we will use the `penguins` data again.
...
We can utilize graphs to explore how different variables are related. In fact, we did so before in our scatterplot. 
Or in this adaptation of our initial plot with a line of best fit for the observed data by each species:
